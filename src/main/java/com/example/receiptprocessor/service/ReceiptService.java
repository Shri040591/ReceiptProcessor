...
public class ReceiptService {
    ...
    public String processReceipt(Receipt receipt) {
        ...
        System.out.println("Rule 1: Points based on retailer name : "+points);
        ...
        System.out.println("Rule 2: Points for round total amount : "+points + "rule 2 :"+total.scale());
        ...
        System.out.println("Rule 3: Points for total being a multiple of 0.25 : "+points);
        ...
        System.out.println("Rule 5: Points for item description length : "+points);
        ...
        System.out.println("Rule 7: Points if purchase day is odd : " + points);
        ...
        System.out.println("Rule 8: Points if purchase time is between 2:00pm and 4:00pm : " +points);
    ...
    public int getPoints(String id){
        // Placeholder logic to return points based on the receipt ID
        return receiptPointsMap.getOrDefault(id, 0); // For simplicity, returning a fixed value
    }
}
